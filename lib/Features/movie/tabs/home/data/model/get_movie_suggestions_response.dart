class GetMovieSuggestionsResponse {
  GetMovieSuggestionsResponse({this.status, this.statusMessage, this.data});

  GetMovieSuggestionsResponse.fromJson(dynamic json) {
    status = json['status'];
