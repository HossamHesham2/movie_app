...
part of 'get_all_movie_response.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class GetAllMovieResponseAdapter extends TypeAdapter<GetAllMovieResponse> {
  @override
  final int typeId = 0;

  @override
  GetAllMovieResponse read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, GetAllMovieResponse obj) {
    writer
      ..writeByte(3)
      ..writeByte(0)
      ..write(obj.status)
  ...
  bool operator ==(Object other) =>
      ...
      other is GetAllMovieResponseAdapter &&
...
class DataAdapter extends TypeAdapter<Data> {
  ...
  Data read(BinaryReader reader) {
    ...
    return Data(
      ...
      movies: (fields[3] as List?)?.cast<Movies>(),
    );
  }
...
class MoviesAdapter extends TypeAdapter<Movies> {
  ...
  Movies read(BinaryReader reader) {
    ...
    return Movies(
      ...
      dateUploaded: fields[24] as String?,
      dateUploadedUnix: fields[25] as int?,
    );
  }
